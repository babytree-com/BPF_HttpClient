...
use BPF\HttpClient\Handler\CurlHandler;
use BPF\HttpClient\Handler\SocketHandler;
use BPF\HttpClient\Handler\Handler;
...
class RequestClient {
    ...
    public function addRequest(string $url, array $options = [], int $mode = self::MODE_SYNC, callable $response_format_func = null) {
        ...
        $request_uniq = \BPF\HttpClient\getRequestUniq($url, $options, $mode); 
